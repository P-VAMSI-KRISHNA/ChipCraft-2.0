  ...
  return (
    <footer className="border-t border-border bg-card/50 py-8 sm:py-12">
      <div className="container px-4 sm:px-6">
        <div className="grid gap-8 sm:gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2">
              ...
              <a href="https://studentbranches.ieee.org/in-kalasalingam-ed/resources/" target="_blank" rel="noopener noreferrer" className="text-sm text-foreground/80 hover:text-primary font-sans font-medium transition-colors flex items-center gap-1">Resources <ExternalLink className="h-3 w-3" /></a>
            </nav>
          </div>
          ...
          <div>
            ...
            <a
              ...
              rel="noopener noreferrer"
              className="group mb-4 flex items-center gap-3 w-fit transition-opacity hover:opacity-90"
              title="KARE IEEE Solid-State Circuits Society"
            >
              <img
                src="/SSCS.png"
                alt="KARE IEEE SSCS Logo"
                className="h-10 w-10 rounded-full border-2 border-foreground/30 bg-white object-contain p-0.5 shadow-sm"
              />
              <div>
                <p className="font-sans font-bold text-sm text-primary tracking-wide leading-tight">KARE IEEE SSCS</p>
                <p className="font-serif text-xs text-muted-foreground leading-tight flex items-center gap-1 mt-1">
                  Visit Website <ExternalLink className="h-3 w-3" />
                </p>
              </div>
        ...
        <div className="mt-6 sm:mt-8 border-t-2 border-dashed border-border pt-4 sm:pt-6 text-center">
          <p className="font-sans font-bold tracking-widest uppercase text-[10px] sm:text-xs text-muted-foreground">
            © {new Date().getFullYear()} CHIPCRAFT 2.0 — KARE IEEE EDS. ALL RIGHTS RESERVED.
          </p>
